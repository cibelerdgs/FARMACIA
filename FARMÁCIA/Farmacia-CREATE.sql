...
CREATE TABLE IF NOT EXISTS `Farmaciadb`.`Compra_has_Medicamento` (
  ...
  PRIMARY KEY (`Medicamento_ID_medic`, `Compra_id`),
  INDEX `fk_Compra_has_Medicamento_Medicamento1_idx` (`Medicamento_ID_medic` ASC),
  INDEX `fk_Compra_has_Medicamento_Compra1_idx` (`Compra_id` ASC),
  ...
  CONSTRAINT `fk_Compra_has_Medicamento_Compra1`
    ...
    REFERENCES `Farmaciadb`.`Compra` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Farmaciadb`.`Email`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Farmaciadb`.`Email` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `Cliente_ID_cliente` BIGINT(20) NOT NULL,
  PRIMARY KEY (`id`, `Cliente_ID_cliente`),
  INDEX `fk_Email_Cliente1_idx` (`Cliente_ID_cliente` ASC),
